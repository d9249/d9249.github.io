...
#-----------------------------------------
ROOT_IMAGE_FOLDER = './'
image_root = ROOT_IMAGE_FOLDER + 'data/original/' 
gt_root = ROOT_IMAGE_FOLDER + 'results/ResNet50/test0.5/'         
height_root = ROOT_IMAGE_FOLDER + 'data/height_map/'   
detected_root = ROOT_IMAGE_FOLDER + 'results/ResNet50/test0.5/'
'''
make output folder  
'''
a = datetime.now()
...
test_loader = test_dataset(image_root, detected_root, detected_root, 400, 2)
...
for i in range(test_loader.size):
    ...
    '''
    torchvision.utils.save_image(res, save_path+name)
