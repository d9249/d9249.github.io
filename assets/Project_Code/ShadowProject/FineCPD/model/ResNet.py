...
class B2_ResNet(nn.Module):
    ...
    def __init__(self, inputchannel = 4):
        # self.inplanes = 128
        self.inplanes = 64
        super(B2_ResNet, self).__init__()
    # Gray By juwan : inchannel : 4 - RGB, 2- Gray
        self.conv1 = nn.Conv2d(inputchannel, 64, kernel_size=7, stride=2, padding= 3,bias=False)
...
class B2_ResNet_WANI(nn.Module):
    # ResNet50 with two branches
    def __init__(self, inputchannel = 4):
        # self.inplanes = 128
        self.inplanes = 64
