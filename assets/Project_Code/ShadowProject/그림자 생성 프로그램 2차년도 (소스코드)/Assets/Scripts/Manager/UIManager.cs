...
public class UIManager : MonoBehaviour
{
    ...
    public Scrollbar barYear, barMonth, barDay, barHour, barMinute;
    ...
    void Update()
    {
        ...
        HOUR = (uint)Math.Truncate(1/24+23 * barHour.value);
        MINUTE = (uint)Math.Truncate(1/60+59 * barMinute.value);
    ...
    {
        SceneManager.LoadScene("Set_Lat_Lon", LoadSceneMode.Single);
    }
}
