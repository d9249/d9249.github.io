...
def get_loader(image_root,height_root ,gt_root, batchsize, trainsize, shuffle=True, num_workers=12, pin_memory=True):
...
class test_dataset:
    def __init__(self, image_root, mask_root,height_root, testsize):
