...
<figure class="market-diagram">
  <img src="/images/projects/market-intelligence-data-lifecycle.svg" alt="Jeani data lifecycle diagram">
  <figcaption>데이터 lifecycle. RFP → 조사 계획 → 병렬 수집 → 종합 보고 → daily_updates 저장 → KB 동기화.</figcaption>
</figure>
...
<figure class="market-diagram">
  <img src="/images/projects/market-intelligence-ops-topology.svg" alt="Jeani ops topology diagram">
  <figcaption>운영 토폴로지. Lambda 에이전트, S3, DynamoDB, EventBridge, Bedrock KB가 Terraform으로 정의됩니다.</figcaption>
</figure>
