...
'AI 항공조업 안전기술'은 **기업혁신대상 대한상공회의소 회장상('25)**을 수상했습니다. 수상작은 A-VLAN의 전신 버전이며 새로운 구조의 설계 및 개발은 직접 진행했습니다. A-VLAN은 그 검증된 문제 의식을 조합형 스킬·목표 주도 루프·시각 앵커링 구조로 전체 시스템을 재설계한 후속 버전입니다.
