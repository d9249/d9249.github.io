...
공개 패키징 상태도 살펴볼 만하다. Hugging Face API 기준으로 이 모델은 `2026-05-04` 생성, `2026-05-08` 수정, likes 251, 지난달 downloads 6,810 수준이며 `model-00001-of-00004.safetensors`부터 `model-00004-of-00004.safetensors`까지 4개 shard로 배포된다. `usedStorage`는 약 53.1GB다. 즉 공개는 꽤 빠르게 이루어졌고, 실제 weights도 이미 올라와 있다.
