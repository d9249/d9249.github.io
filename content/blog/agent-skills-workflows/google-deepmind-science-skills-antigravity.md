...
tags:
  ...
  - AI for Science
  - Agent Skills
image: "/images/blog/science-skills-operating-stack.svg"
draft: false
---
...
<figure style="margin: 1.8rem 0;">
  <img
    src="/images/blog/science-skills-operating-stack.svg"
    alt="Science Skills를 입력, 작업 환경, 제어 계층, 근거 계층, 검증 산출물로 나누어 보여주는 운영 스택"
    style="width: 100%; max-width: 100%; height: auto; display: block;"
  />
  <figcaption style="margin-top: 0.6rem; font-size: 0.95rem; color: #666;">
    Science Skills를 반복 카드가 아니라 실행 계층으로 재구성한 그림. 논문과 기술 글에서 출발해 Antigravity 작업 환경, Science Skills 제어 계층, 도메인별 과학 소스를 거쳐 검증 산출물로 이어지는 구조를 보여준다.
  </figcaption>
</figure>
...
<figure style="margin: 1.8rem 0;">
  <img
    src="/images/blog/science-skills-impact-comparison.svg"
    alt="Science Skills 적용 전후의 성공률, 토큰 사용량, BioReason 비-SNV 성능 변화를 비교한 보드"
    style="width: 100%; max-width: 100%; height: auto; display: block;"
  />
  <figcaption style="margin-top: 0.6rem; font-size: 0.95rem; color: #666;">
    공식 technical report의 핵심 수치를 전후 비교로 재구성한 그림. 같은 모델이라도 Science Skills를 적용하면 성공률은 올라가고, 평균 token 사용량은 줄며, BioReason 비-SNV 변이 추론 성능도 크게 개선된다.
  </figcaption>
</figure>
