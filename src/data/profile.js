...
export const skillGroups = [
  ...
  },
  {
    ...
    skills: [
      "LLM (SLM, LLM, Embedding) Optimization / Serving",
      "RAG (Vector based, Graph based)",
      "Prompt Engineering",
      "Agent(single, multi)",
      "Object Detection (Prompt-based, Open-world)",
      "Image Segmentation",
      "Image Classification",
      "Pose Estimation",
      "Recommendation Systems / GNN (GCN, GIN, Optimization)",
      "Prediction / Regression / Classification (Structured / Unstructured, Time Series)",
      "Ensemble",
      "Parameter Optimization",
      "Augmentation",
      "Pre / Post Processing",
      "NLP (Multilingual Processing, Document Layout Analysis, OCR)",
      "Vector Database",
      "MLOps",
    ],
  },
